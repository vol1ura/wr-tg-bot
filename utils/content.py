...
'Нет штрих-кода - нет результата!', 'Суббота. Утро. Парк (Кузьминки).',
...
"goldenringultratrail", "begovoy.monastyr", "diehardrunning", "russiarunning", "stepan_kiselev_run", "parkrunkuzminki",
...
about_message = "<b>Чат-бот Wake&Run</b>, версия 0.3.14\n" \
...
🕗 четверг 20:00 🌲 [парк Кузьминки](https://yandex.ru/maps/-/CCUyJ4dXxD)
🕗 четверг 20:00 🌳 [парк Олимпийская деревня](https://yandex.ru/maps/-/CCUINOas0A)
🕘 воскрeсенье 09:00 🌲 [парк Кузьминки](https://yandex.ru/maps/-/CCUyJ4dXxD)

При нажатии на гиперссылку oткроется карта с точкой встречи.
"""

Coordinates = namedtuple('coordinates', 'lat lon')
places = {
    'Кузьминки': Coordinates('55.693191', '37.778019'),
    'Москва центр': Coordinates('55.738547', '37.611002'),
